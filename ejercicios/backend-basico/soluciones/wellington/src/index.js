...
app.put("/tareas/:id", (req, res) => {
  ...
  if (descripcion !== undefined) tarea.descripcion = typeof descripcion === "string" ? descripcion.trim() : "";
...
app.delete("/tareas/:id", (req, res) => {
  ...
  if (index === -1) return res.status(404).json({ success: false, error: "Tarea no encontrada" });
